...
<head>
  ...
  <title>个人信息</title>
	<body>
    	...
    	<span class="pro-line"><img src="http://localhost/xiao/tpp/Public/img/pro-line4.png"></span>
		</div>
		<ul class="dorm-book">
			<li class="upload-head ta-center">
				<span>
					<img src="http://localhost/xiao/tpp/Public/img/take-photo.png">
					<input type="file" />
				</span>
				<p>上传头像</p>
			</li>
			...
			<li>
		        ...
		        <input type="text" name="name" placeholder="请填写您的个人邮箱地址" />  
			</li>
			<li>
			...
			<li>
		        ...
		        <input type="text" name="name" placeholder="请填写您的家庭主机号码" />  
			</li>
			<li>
