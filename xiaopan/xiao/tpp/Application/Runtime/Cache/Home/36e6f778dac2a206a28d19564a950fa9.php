		...
		<div class="report-process">
			<ul class="process-inner">
				<li class="clearfix line1">
					<span class="pro-img"><img src="http://localhost/xiao/tpp/Public/img/register-in.png"></span>
					<div class="pro-word"> 
						<h3>个人信息</h3>
				...
				<li class="clearfix">
					<span class="pro-img"><img src="http://localhost/xiao/tpp/Public/img/book-room.png"></span>
				...
				<li class="clearfix">
					<span class="pro-img"><img src="http://localhost/xiao/tpp/Public/img/arrive.png"></span>
					<div class="pro-word  nodo"> 
						<h3>抵校登记</h3>
				...
				<li class="clearfix pb0">
					<span class="pro-img"><img src="http://localhost/xiao/tpp/Public/img/print.png"></span>
					<div class="pro-word nodo"> 
						<h3>打印报到单</h3>
