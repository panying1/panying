...
<head>
  ...
  <title>报到单</title>
	<body>
    	...
    	<span class="pro-line"><img src="http://localhost/xiao/tpp/Public/img/pro-line2.png"></span>
		</div>
		<ul class="dorm-book mt3">
			<li class="info-top clearfix">
				<span class="heade-img">
					<img src="http://localhost/xiao/tpp/Public/img/person.png">
				</span>
			    <span class="stu-name">江静静</span>
			    <span class="code"><img src="http://localhost/xiao/tpp/Public/img/code.png"></span>
			</li>
			<li class="basic-tit">
			    宿舍基本信息
			</li>
