	...
	<head>
		...
		<body>
			...
			<div class="contain">
						...
						<div style="display: block;">
							<ul class="dorm-book">
								...
								<li>
									...
									<input type="text" name="name" placeholder="请填写您的民族类别" />
								</li>
								<li>
									<span class="book-tit">手机</span>
									<input type="text" name="name" placeholder="请填写您的个人手机号码" />
								</li>
								<li>
									<span class="book-tit">出生年月</span>
									<input type="text" name="name" placeholder="请填写您的出生日期" />
								</li>
								<li>
									<span class="book-tit">身份证号</span>
									<input type="text" name="name" placeholder="请填写您的身份证号码" />
								</li>
								<li>
									<span class="book-tit">联系手机</span>
									<input type="text" name="name" placeholder="请填写您的手机联系号码" />
								</li>
								<li>
									<div class="show-btn">
								...
								<li>
									<a href="adress.html">
										...
										<input type="text" name="name" placeholder="请所在地地址" disabled="disabled" />
									</a>
									<span class="goin"><i class="iconfont icon-right"></i></span>
								</li>
								<li>
									<span class="book-tit">详细地址</span>
									<input type="text" name="name" placeholder="请填写您的详细地址" />
								</li>
							</ul>
						</div>
						<div>
				...
				<div class="step-btn">
					<a href="#" class="ta-center db">提交</a>
				</div>
			<div class="cover-bg"></div>
			<script src="http://localhost/xiao/tpp/Public/js/jquery-1.10.2.min.js"></script>
			<script type="text/javascript" src="http://localhost/xiao/tpp/Public/js/basic.js"></script>
