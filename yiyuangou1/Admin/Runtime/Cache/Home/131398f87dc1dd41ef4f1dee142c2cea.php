...
<div class="container clearfix">
   ...
   <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="<?php echo U('index/index')?>">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">用户修改</span></div>
        </div>
...
<form action="../../update_do" method="post">
    <table height="100px" height="1100px">
         <input type="hidden" name="uid" value="<?php echo $arr['uid']?>">
                <tr>
                    <td>姓名</td>
                    <td><input type="text" name='username' value="<?php echo $arr['username']?>"required></td>
                </tr>
                <tr>
                   <td>密码</td>
