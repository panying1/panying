...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
    <meta charset="utf-8">
    <title>Apple iPhone SE 64G 移动联通电信4G手机 - Apple iPhone SE 64G 移动联通电信4G手机</title>
    <meta name="description" content="Apple iPhone SE 64G 移动联通电信4G手机">
    <meta name="keywords" content="Apple iPhone SE 64G 移动联通电信4G手机">
    <link href="/Public/cart/oenpay.css" rel="stylesheet">
    <link href="/Public/cart/jquery.css" rel="stylesheet">
	<link href="/Public/cart/product.css" rel="stylesheet">
    <!--[if lt IE 8]>
	<style type="text/css">
	...
	<![endif]-->
  <script src="/Public/cart/share.js"></script><style type="text/css">#kf-content-div a,
#kf-content-div p {
...
<div class="top-back">
	...
	<div class="navbar category">
  	...
  	<div class="top-backs">
	  	<div class="container">
			<!-- 所在位置 - 开始 -->
			<div class="w-dir"><a href="<?php echo U('index/index')?>">首页</a> &gt; <a href="">全部商品</a> &gt;  <a href="http://localhost/shiyi/yyy/index.php?s=/list/index/id/14"></a> &gt;  <?php echo ($re["g_name"]); ?> <?php echo ($re["goods_title"]); ?> [期号：<?php echo rand(1000,123).$re['g_id']?>]</div>
			<!-- 所在位置 - 结束 -->
	  	</div>
  	</div>
  	...
  	<div class="container">
  		<div class="porduct-block">
  			...
  			<div class="product-show">
  				<div class="preview">
                    <div id="vertical" class="bigImg">
						<img src="/<?php echo ($re["filename"]); ?>" alt="" id="midimg" width="400" height="400">
  			...
  			<!-- 产品放大镜结束 -->
  			<h1 class="porduct-h2"><?php echo ($re["g_name"]); ?> <span class="red">颜色随机 支持专柜验货</span></h1>
  			<div class="product-naving">
  				<div class="reco-ls huise">总需：<span class="big black"><?php echo ($re["partake_people"]); ?></span> 人次</div>
				<div class="progress">
				    <span class="orange" style="width: 0%;"></span>
				</div>
				<div class="reco-nb huise">
					<div class="reco-lnb"><span class="big black"><?php echo ($re["can"]); ?></span><br>已参与人次</div>
					<div class="reco-rnb"><span class="big black"><?php echo ($re["people"]); ?></span><br>剩余人次</div>
				</div>
				<div class="porduct-reco"><b class="blue"><?php echo ($re["can"]); ?></b>人次已参与，赶快去参加吧！剩余<b class="red"><?php echo ($re["people"]); ?></b>人次</div>
			<form action="/index.php/home/pay/pay?id=<?php echo ($re["g_id"]); ?>" method="post">
				<div class="ro-goods reco-ing">
					我要参与：
					<div class="ro-goods-inputs">
						<input value="<?php echo ($re["g_id"]); ?>" name="pid" type="hidden">
						<input value="1" price="<?php echo ($re["goods_money"]); ?>" unit="1" surplus="<?php echo ($re["goods_money"]); ?>" limit="0" name="number" type="type">
					...
					<b class="renci_sz" val="30">30</b>
					<b class="renci_sz" val="50">50</b>
					<b class="renci_sz" val="100">100</b>
					<b class="renci_sz" val="4888">包尾</b>					人次
				...
				</form>				<div class="shareto">
					<div class="text">分享到：</div>
					<div class="bdsharebuttonbox bdshare-button-style1-32" data-bd-bind="1479954096190">
  			...
  			<div class="my-codes my-codes-long">
				<div class="no-login"><a href="<?php echo U('login/login')?>" class="a3">请登录</a>，查看你的夺宝号码！</div>
			</div>
			<?php }?>
			  		</div>
  		<div class="porduct-rg-block">
  			<h3>开奖信息</h3>
  			<div class="por-block pro-block1 history" url="/shiyi/yyy/index.php?s=/shop/history/sid/385" no="100001" maxno="" minno="" style="display: none;">
  				...
  				<div class="user-img"><img class="notimg" src="/Public/cart/shop_img.htm"></div>
  				<div class="user-zj-name">恭喜 <a href="http://localhost/shiyi/yyy/%7B%7Bshop_user_url%7D%7D" class="a3">{{shop_name}}</a> <span class="green">({{shop_address}})</span> 获得了 <span class="red">Apple iPhone SE 64G 移动联通电信4G手机</span></div>
  				<hr>
  				...
  				<div class="bottom-btn" style="padding-top:14px;padding-bottom: 16px">
  					<a href="http://localhost/shiyi/yyy/%7B%7Bshop_url%7D%7D" class="btn btn-yellow">查看详情</a>
  				</div>
  			</div><div class="por-block pro-block1"><span class="icon icon-attention"></span> 暂时没有数据</div>
  		</div>
  		<div class="clear"></div>
  	</div>
  	...
  	<div class="container">
		<div class="product-nav-t">
			...
			<div class="product-content">
				<div class="tabs-panel-item" style="display: block;">
					<div class="product-show-nav">
						<p style="text-align:center"><img src="/Public/cart/56f1ea1c90e7c.htm" title="56f1ea1c90e7c.jpg"></p><p style="text-align: center;"><img src="/Public/cart/56f1ea1c9e987.htm" style="" title="56f1ea1c9e987.jpg"></p><p style="text-align:center"><img src="Apple%20iPhone%20SE%2064G%20%E7%A7%BB%E5%8A%A8%E8%81%94%E9%80%9A%E7%94%B5%E4%BF%A14G%E6%89%8B%E6%9C%BA%20-%20Apple%20iPhone%20SE%2064G%20%E7%A7%BB%E5%8A%A8%E8%81%94%E9%80%9A%E7%94%B5%E4%BF%A14G%E6%89%8B%E6%9C%BA_files/56f1ea1ca2468.htm" title="56f1ea1ca2468.jpg"></p><p style="text-align:center"><img src="Apple%20iPhone%20SE%2064G%20%E7%A7%BB%E5%8A%A8%E8%81%94%E9%80%9A%E7%94%B5%E4%BF%A14G%E6%89%8B%E6%9C%BA%20-%20Apple%20iPhone%20SE%2064G%20%E7%A7%BB%E5%8A%A8%E8%81%94%E9%80%9A%E7%94%B5%E4%BF%A14G%E6%89%8B%E6%9C%BA_files/56f1ea1cd9a5f.htm" title="56f1ea1cd9a5f.jpg"></p><p style="text-align:center"><img src="Apple%20iPhone%20SE%2064G%20%E7%A7%BB%E5%8A%A8%E8%81%94%E9%80%9A%E7%94%B5%E4%BF%A14G%E6%89%8B%E6%9C%BA%20-%20Apple%20iPhone%20SE%2064G%20%E7%A7%BB%E5%8A%A8%E8%81%94%E9%80%9A%E7%94%B5%E4%BF%A14G%E6%89%8B%E6%9C%BA_files/56f1ea1ce3229.htm" title="56f1ea1ce3229.jpg"></p><p style="text-align: center;"><img src="Apple%20iPhone%20SE%2064G%20%E7%A7%BB%E5%8A%A8%E8%81%94%E9%80%9A%E7%94%B5%E4%BF%A14G%E6%89%8B%E6%9C%BA%20-%20Apple%20iPhone%20SE%2064G%20%E7%A7%BB%E5%8A%A8%E8%81%94%E9%80%9A%E7%94%B5%E4%BF%A14G%E6%89%8B%E6%9C%BA_files/56f1ea1d04fbc.htm" title="56f1ea1d04fbc.jpg"></p>					</div>
				...
				<div class="tabs-panel-item">
					<div class="recordlist recordScrollbar">
						...
						<div class="record-list" url="/shiyi/yyy/index.php?s=/shop/record/pid/208">
							<ul>
								<li>
									...
									<div class="avatar">
										<div class="record">
											<div class="userimgs"><img class="notimg" src="/Public/cart/shop_img.htm"></div>
											<a href="http://localhost/shiyi/yyy/%7B%7Bshop_user_url%7D%7D" class="a3">{{shop_name}}</a>
				...
				<div class="tabs-panel-item shareScrollbar">
					<div class="detail-shareList">
						<ul class="share-list" url="/shiyi/yyy/index.php?s=/user/displays/sid/385">
							<li class="user-images"><img class="notimg" src="/Public/cart/shop_img.htm"></li>
							<li class="sharenav">
								<h5><a href="http://localhost/shiyi/yyy/%7B%7Bshop_user_url%7D%7D">{{shop_name}}</a></h5>
								<div class="share-time">{{shop_time}}</div>
								<a href="http://localhost/shiyi/yyy/%7B%7Bshop_url%7D%7D" class="text">{{shop_content}}</a>
								<a href="http://localhost/shiyi/yyy/%7B%7Bshop_url%7D%7D">
								<div class="share-img each">
									<span class="share-center"></span><img class="notimg" src="/Public/cart/shop_thumbpic.htm">
								</div>
								</a>
							</li>
						</ul>
  	...
  	<div class="back-black users" style="display: none;">
  		<div class="more-number">
  			...
  			<div class="monu-body">
  				<h3>您本期总共参与了<span class="red">0</span>人次</h3>
  				<dl class="content mCustomScrollbar light _mCS_1 mCS-autoHide mCS_no_scrollbar" data-mcs-theme="minimal-dark" style="position: relative; overflow: visible;"><div id="mCSB_1" class="mCustomScrollBox mCS-minimal-dark mCSB_vertical mCSB_outside" style="max-height: 0px;" tabindex="0"><div id="mCSB_1_container" class="mCSB_container mCS_y_hidden mCS_no_scrollbar_y" style="position:relative; top:0; left:0;" dir="ltr">
	...
	<div class="message-fixed">
		<div id="moquu_top" style="display: none;">
			<div class="icons">
				<span class="top"></span>
				<b>返回顶部</b>
			</div>
	...
	<script src="/Public/cart/jquery.js"></script>
	<script src="/Public/cart/jquery_003.js"></script>
	<script src="/Public/cart/jquery_002.js"></script>
	<script type="text/javascript">var htmltype;</script>
	<script src="/Public/cart/script.js"></script>
	<!--[if lt IE 9]>
	<script src="/shiyi/yyy/Template/Web/js/jquery.pseudo.js"></script>
	<![endif]-->
	<script type="text/javascript">
		...
		window._bd_share_config={"common":{"bdSnsKey":{},"bdText":text,"bdDesc":text,"bdMini":"1","bdMiniList":false,"bdPic":"/wx-logo.png","bdStyle":"1","bdSize":"32"},"share":{}};with(document)0[(getElementsByTagName('head')[0]||body).appendChild(createElement('script')).src='http://bdimg.share.baidu.com/static/api/js/share.js?v=89860593.js?cdnversion='+~(-new Date()/36e5)];
	</script>
