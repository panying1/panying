...
<html lang="zh-CN">
  <head>
    ...
    <link href="/Public/index/css/login.css" rel="stylesheet">
    <!--[if lt IE 8]>
	<style type="text/css">
...
<div class="top-back">
	...
	<div class="cent margin">
		...
		<!-- 分步显示结束 -->
		<form method="post" action="" class="form-user" class="form-user">		
		<div class="input-lse">
			<h2>恭喜你，成功写入新密码</h2>
			<h3><a href="<?php echo U('login/login')?>" style="text-decoration:none;align:center;padding:0 70px;"><font color='red'>请登录</font></a></h3>
		</div>
		</form>
    </div>
	<div class="clear"></div>
	...
	<script type="text/javascript">var tplpath='/Public'</script>
