...
<div class="top-back">
	...
	<div class="cent margin">
		...
		<!-- 分步显示结束 -->
		<form method="post" action="<?php echo U('pwd/index1ok')?>" class="form-user" class="form-user">	
			<div style="padding:0 360px;">
		<?php if(session("?username")){?>
                    <h2 ><font color='red'><?php echo $_SESSION['username']; ?></font></h2>
                    <?php }?>	
                    </div>
		<div class="input-lse">
			<label>新密码：</label>
